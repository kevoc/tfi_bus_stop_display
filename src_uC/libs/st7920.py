...
"""
class Screen(Canvas):
    def __init__(self, spi=None, resetDisplayPin=None, slaveSelectPin=None, baudrate=1800000):
        ...
        if self.resetDisplayPin is not None:
            self.resetDisplayPin.switch_to_output()

        self.slaveSelectPin = slaveSelectPin
        if self.slaveSelectPin is not None:
            self.slaveSelectPin.switch_to_output()
